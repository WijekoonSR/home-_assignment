    ...
    return (
        <>
            <div className="col-sm-8 col-md-8 col-lg-8">
                <div className="">
                    <input className="mb-4 d-inline" type="number" value={props.input.value} onChange={(e)=>props.handlerChangeAllowance(props.input._id, e.target.value, props.input.isEPF)}/>
                    <span>
                        <img
                            ...
                            onClick={() => {
                                ...
                                props.handlerDeleteAllowance(props.input._id)
                            }
                            }
                        />
                    </span>
